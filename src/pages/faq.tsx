      ...
      <div className="wrapper">
        ...
        <div className="faq-container">
          ...
          <div className="article">
            <p>
              Check here to get any questions answered that you may have about
              the course. Don't see a question that you need answered?{' '}
            ...
            <div>
              ...
              <p>
                <em>
                  Students should have a modest computer at minimum with
                  internet access able to run a text editor and command line
                  scripts. They should have the mobile development environment
              ...
              <p>
                <em>
                  ...
                  to follow, although they are not limited by these tracks and
                  can skip around. If you are comfortable using Angular (v2+),
                  then follow the NativeScript with Angular track. If you are
              ...
              <p>
                <em>
                  Our courses are broken down by level of experience. The
                  Getting Started courses for both{' '}
              ...
              <p>
                <em>
                  Students should have a modest computer at minimum with
                  internet access able to run a text editor and command line
                  scripts. If you have an IDE on your laptop (Visual Studio
                  Code, WebStorm, Notepad++ etc), you are in good shape.
                </em>
              </p>
              <h2>
              ...
              <p>
                <em>
                  ...
                  pre-recorded video presentations and demos for you to watch
                  and learn at your own pace. If you find you are interested in
                  more direct interaction and opportunities to ask questions,
                  check out our partners'{' '}
                  <a href="https://nativescript.training">
                    Live Class offering
                  </a>{' '}
                  .
                </em>
              ...
              <p>
                <em>
                  The content and presentation of the on-demand class material
                  is all pre-recorded, so live interaction during the
                  presentations is not included. However, with the{' '}
                  <a href="https://nativescript.training">Live Classes</a>{' '}
                  offered by our partners, you will have the opportunity to ask
                  questions daily during the class. Should you have any
                  questions about the specific on-demand course materials found
                  here, you can tweet the author. The author information is
                  found on our{' '}
              ...
              <p>
                <em>
                  ...
                  material at the pace that is perfect for you and your
                  schedule. Once you purchase a course or a bundle, you will
                  have immediate access to the content included in that bundle
                  to start your learning immediately and take as much, or as
                  little, time as you need.
                </em>
              </p>
              <h3>
              ...
              <p>
                <em>
                  ...
                  to access the course to review any chapters that you need to
                  at any time. In addition, with NativeScripting's commitment to
                  evergreen content, when updates are made to the course, you
                  will be notified so that you can review the new content, at no
                  additional cost!
                </em>
              </p>
              ...
              <p>
                <em>
                  ...
                  Progress adds new features and capabilities to the
              ...
              <p>
                <em>
                  The course is only available for streamed online viewing and
                  is not available for downloaded or offline viewing at this
                  time.
                </em>
              </p>
              <h2>Purchasing Options</h2>
              <h3>
                If I buy the NativeScript with Angular Super Bundle but want
                more, can I upgrade to the Ultra Bundle?
              </h3>
              <p>
                <em>
              ...
              <p>
                <em>
                  For companies who are interested in private training
                  deliveries, please send me an email at info@nuvious.com and we
                  can chat about your needs and goals for your training.
                </em>
              </p>
              <h3>
              ...
              <p>
                <em>
                  Absolutely! For teams of 10 can enjoy a special 25% discount.
                  To arrange this, send me an email at info@nuvious.com for a
              ...
              <p>
                <em>
                  Yes, certain discounts can be combined. For example, if there
                  is a sale price listed on a course or bundle, and you also
                  have a coupon code, then you will be able to combine
                  discounts. You will not be able to combine multiple coupon
                  codes.
                </em>
              </p>
              <h3>
              ...
              <p>
                <em>
                  Absolutely! Just send me an email at info@nuvious.com and we
                  can chat about it.
                </em>
              </p>
              ...
              <p>
                <em>
                  ...
                  accept wire transfer payments for international customers.
                  Note that wire transfer payments will incur a $15USD fee.
                </em>
              </p>
              <h3>What is your refund policy?</h3>
              <p>
                <em>
                  Our goal is 100% satisfaction from our students. If you find
                  the course did not meet your expectations, please contact me
                  at info@nuvious.com and we can discuss how we can remedy the
                  situation. All sales are final fourteen (14) days after date
                  of purchase and no refunds will be issued beyond that date.
                </em>
              </p>
              ...
              <p>
                <em>
                  ...
                  invoice send us your details and we'll get one back to you
                  right away.
                </em>
              </p>
            </div>
