        ...
        <div className="hero">
            <div className="hero-content">
                <div className="wrapper">
                    ...
                    <h2 className="hero-main-title">Turn up your NativeScript training to 404</h2>
                    <p>
                        But first, you need to find the right place.
                    </p>


                    <p className="bundle-notice">
                        You are likely looking for our amazing NativeScript courses, which can be found <a href="/">here</a>.
                    </p>
