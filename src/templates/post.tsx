...
const PostTemplate: React.StatelessComponent<PostPageProps> = (props: PostPageProps) => {

  const authors = props.data.authorsConnection.edges.map(authorFromAuthorsJsonEdge);
