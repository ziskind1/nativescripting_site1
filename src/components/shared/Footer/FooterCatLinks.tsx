        ...
        <GridRow style={style}>
            <GridColumn xs={6} sm={3} md={3}>
                ...
                <div className="ftr-cat-links">
                    ...
                    <FooterLink href="https://nativescript.training">On-site Training</FooterLink>
                    <FooterLink href="/contact">Team (contact us)</FooterLink>
                    <FooterLink href="/contact">Enterprise (contact us)</FooterLink>
                    <FooterLink href="/contact">Schools (contact us)</FooterLink>
                </div>
            </GridColumn>
            <GridColumn xs={6} sm={3} md={3}>
            ...
            <GridColumn xs={6} sm={3} md={3}>
                ...
                <div className="ftr-cat-links">
                    ...
                    <FooterLink href='https://sso.teachable.com/secure/89912/users/sign_in?reset_purchase_session=1'>Login</FooterLink>
                </div>
            </GridColumn>
